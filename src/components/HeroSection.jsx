...
export default function HeroSection({ bride, groom, dateLabel, locationLabel }) {
  ...
  return (
    <MotionSection
      id="home"
      className="relative isolate flex min-h-[calc(100vh-.75rem] items-center overflow-hidden scroll-mt-28 px-4 pb-10 pt-10 md:min-h-[calc(100vh-5rem)] md:pb-12 md:pt-12"
      initial="hidden"
      animate="visible"
